...
ENV PACKAGES wget make cmake gcc git libglib2.0-dev cmake pkg-config gsl-bin libnlopt-dev libsuitesparse-dev libgsl0-dev mpi-default-bin

ENV PETSC_URL http://ftp.mcs.anl.gov/pub/petsc/release-snapshots/petsc-3.5.4.tar.gz
ENV PETSC_DIR /opt/petsc-3.5.4
ENV PETSC_ARCH "arch-linux2-c-debug"


ENV SLEPC_URL http://slepc.upv.es/download/download.php?filename=slepc-3.5.4.tar.gz
